...
export const LimelightNav = ({
  ...
  return (
    <nav className={`relative inline-flex items-center h-16 rounded-lg bg-gray-800/40 text-gray-200 border border-white/10 px-2 ${className}`}>
      ...
      <div 
        ref={limelightRef}
        className={`absolute top-0 z-10 w-11 h-[5px] rounded-full bg-blue-500 shadow-[0_50px_15px_rgba(59,130,246,0.5)] ${
